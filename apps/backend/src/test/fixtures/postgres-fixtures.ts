const TABLE_DEFINITIONS: Record<string, string> = {
  ...
  departement: `
    CREATE TABLE departement (
      numero_departement VARCHAR(10) PRIMARY KEY,
      nom VARCHAR(40) NOT NULL,
      region_id INT NULL REFERENCES region(numero_region)
    );
  `,
  metropole: `
  ...
  demographie: `
    CREATE TABLE demographie (
      id SERIAL PRIMARY KEY,
      commune_id VARCHAR(10) NOT NULL UNIQUE REFERENCES commune(commune_id),
      population INT,
      age_moyen INT,
      pop_active REAL,
      taux_chomage REAL,
...
const BASE_DATA_SQL = `
  INSERT INTO region (numero_region, nom) VALUES
    (11, 'Ile-de-France'),
    (53, 'Bretagne'),
  ...
  INSERT INTO departement (numero_departement, nom, region_id) VALUES
    ('75', 'Paris', 11),
    ('69', 'Rhone', 84),
  ...
  INSERT INTO demographie (
    ...
    ('75056', 2145906, 36, 65, 7.5, 20566, 43000, 105, 14, 21, 24, 18, 13, 8, 2, 28, 19, 14, 8, 12, 32, 18, 28),
    ('75057', 98000, 37, 63, 6.9, 21500, 41000, 18, 13, 20, 26, 18, 14, 7, 2, 25, 21, 15, 8, 11, 29, 17, 31),
    ('69123', 522228, 38, 64, 7.1, 10700, 32000, 48, 15, 22, 23, 17, 13, 8, 2, 21, 20, 16, 10, 13, 24, 19, 29),
  ...
  INSERT INTO scores (
    ...
    ('75056', 3.8, 4.0, 3.2, 4.1, 3.4, 3.9),
    ('75057', 4.1, 4.2, 3.5, 4.0, 3.6, 4.0),
    ('69123', 3.5, 3.9, 4.4, 4.3, 4.0, 4.1);
  ...
  INSERT INTO sante (
    ...
    ('75056', 428, 39, 74, 18, 26, 5100, 1850, 640, 120, 160, 88, 104, 46, 52, 140, 72, 95, 210, 41, 380, 67, 44, 315);
  ...
  INSERT INTO commerces (
    ...
    ('75056', 8, 142, 210, 1290, 420, 14800, 310, 42, 280, 96, 2150, 380, 1700, 73, 27, 115),
    ('69123', 6, 96, 130, 480, 160, 5200, 220, 29, 120, 41, 840, 145, 650, 29, 14, 72);
`;
